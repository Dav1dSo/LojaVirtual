            ...
            <form method="POST" action="/product/edit/{{ $dataProducts->id }}" enctype="multipart/form-data">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input value="{{ $dataProducts->valor }}" type="text" class="form-control  @error('valor') is-invalid @enderror " id="valor"
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control @error('descricao') is-invalid @enderror" id="descricao" placeholder="Descrição do produto:" rows="4" name="descricao">{{ $dataProducts->descricao }}</textarea>
                    @error('descricao')
                        <p class="text-danger">{{ $message }}</p>
                    @enderror
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input value="{{ $dataProducts->imagem }}" type="file" class="form-control @error('imagem') is-invalid @enderror " id="imagem" name="imagem[]" multiple>
                        @error('imagem')    
                            <p class="text-danger">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <input value="{{ $dataProducts->estoque }}" type="number" class="form-control @error('estoque') is-invalid @enderror" id="estoque"
